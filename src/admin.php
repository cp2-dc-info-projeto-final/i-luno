<?php
    ...
    if((!isset($_SESSION['nomeusu']) == true) and (!isset($_SESSION['senha']) == true))
    {
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        <a class='btn btn-sm btn-danger' href='tornaradmin.php?id=$user_data[id]' title='Deletar'> Tornar admin</a>
